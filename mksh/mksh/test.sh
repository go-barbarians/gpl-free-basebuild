#!/work/barbarians/base-image/mksh/mksh/mksh
LC_ALL=C PATH='/home/ubuntu/bin:/home/ubuntu/.local/bin:/home/ubuntu/bin:/home/ubuntu/.local/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/usr/local/games:/snap/bin:/work/barbarians/base-image/target/musl/bin:/work/barbarians/base-image/target/musl/bin/bin'; export LC_ALL PATH
test -n "$KSH_VERSION" || exit 1
set -A check_categories --  shell:legacy-no int:32 shell:textmode-no shell:binmode-yes
pflag='/work/barbarians/base-image/mksh/mksh/mksh'
sflag='./check.t'
